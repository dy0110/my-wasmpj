import * as wasm from './my_wasmpj_bg.wasm';
...
export function __wbg_setinnerWidth_01d2defc07a6ad77() { return handleError(function (arg0, arg1) {
    getObject(arg0).innerWidth = getObject(arg1);
}, arguments) };

export function __wbg_setinnerHeight_996d4e32bdc9b733() { return handleError(function (arg0, arg1) {
    getObject(arg0).innerHeight = getObject(arg1);
}, arguments) };
